...
//		System.out.println(getTimeFormat(calendar.getTime()));
	...
	/**
	 * 
	 * @param time(ʱ��ͷ����ַ��ʽ��:8:10)
	 * @param addminute(�Ӻͼ�����ʱ��) 
	 * @param mark(add��ʱ�䣬minus��ʱ��)
	 * @return
	...
	public static String getHourMinus(String time,int addminute,String mark) {
		...
		try {
			...
			DateTime d  = null;
			if(MehStringUtil.isEmpty(mark))mark="add";
			if(mark.equals("add")){
