...
public class ReflectUtil2 {
	 ...
	 * 手机:1564545646464<br/>
	 * @param clz
	 * @param params 就是值啊 1，"name",21.5f,Array,1L
	 * @return Object<br/>
	 * @exception <br/>
	 * @since  1.0.0<br/>
	 */
	...
	public static void main(String[] args) {
		...
		Class class1;
		try {
			class1 = Class.forName("class_26_reflect.User");
			User user= (User) ReflectUtil2.getObject(class1, 1,"keke",12.5f,names,5l);
