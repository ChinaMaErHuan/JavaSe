package class_40_jdbc_and_lamba.ex;
...
//		ConvertFK convert =Integer::parseInt;
//		ConvertFK convertFK = new ConvertFK() {
//			
//			@Override
//			public Integer convert(String numberString) {
...
//		String sreString = "ljaskld";
//		System.out.println(sreString.toUpperCase());
		
		
		//匿名内部类和lambda表达式的区别 lamba不可以调用接口中的默认方法
